...
<header><nav><a href="../course/">Interactive course</a> · <a href="../">Recorded IDS demo</a> · <a href="https://github.com/buffbeefalo/netmambaplus-reproduction">Repository</a></nav>
<p class="eyebrow">The reproduction lab · video course</p><h1>Understand what actually ran.</h1>
<p class="lede">Thirty minutes on NetMamba+: the paper, the two packet CSVs, the compatible flow data, training, inference, measured results and what remains to build.</p></header>
