> Historical two-route client-delivery record, preserved from source commit `19f849c`. The [current delivery](client-edition.md) supports the CSV packet workflow only.
